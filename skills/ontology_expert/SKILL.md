...
6. **Artifact Regeneration**: After enum-related changes, regenerate `staging/full_schema_model.json`, `staging/pydantic_schema_model.py`, and `staging/neo4j_query_context.md` so downstream review/code remain in sync.
